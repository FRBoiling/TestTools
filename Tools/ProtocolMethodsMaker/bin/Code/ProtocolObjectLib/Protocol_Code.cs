...
{
MSG_ZGC_MONSTER_SIMPLE_INFO MSG_ZGC_MONSTER_SIMPLE_INFO = ProtoBuf.Serializer.Deserialize<MSG_ZGC_MONSTER_SIMPLE_INFO>(stream);
...
{
return  ProtoBuf.Serializer.Deserialize<MSG_ZGC_MONSTER_SIMPLE_INFO>(stream);
}

public void OnResponse_MODEL_INFO(MemoryStream stream,out string msgName)
{
...
{
MSG_ZGC_MONSTER_INFO MSG_ZGC_MONSTER_INFO = ProtoBuf.Serializer.Deserialize<MSG_ZGC_MONSTER_INFO>(stream);
...
{
return  ProtoBuf.Serializer.Deserialize<MSG_ZGC_MONSTER_INFO>(stream);
}

public void OnResponse_MSG_ZGC_MONSTER_LEAVE(MemoryStream stream,out string msgName)
{
MSG_ZGC_MONSTER_LEAVE MSG_ZGC_MONSTER_LEAVE = ProtoBuf.Serializer.Deserialize<MSG_ZGC_MONSTER_LEAVE>(stream);
...
{
return  ProtoBuf.Serializer.Deserialize<MSG_ZGC_MONSTER_LEAVE>(stream);
}

public void OnResponse_MSG_GC_MONSTER_ENTER_LIST(MemoryStream stream,out string msgName)
{
MSG_GC_MONSTER_ENTER_LIST MSG_GC_MONSTER_ENTER_LIST = ProtoBuf.Serializer.Deserialize<MSG_GC_MONSTER_ENTER_LIST>(stream);
...
{
return  ProtoBuf.Serializer.Deserialize<MSG_GC_MONSTER_ENTER_LIST>(stream);
}

public void OnResponse_CURRENCY(MemoryStream stream,out string msgName)
{
...
public void OnResponse_ZGC_COUNTER(MemoryStream stream,out string msgName)
{
...
public void OnResponse_MSG_ZGC_KNAPSACK_SYNC(MemoryStream stream,out string msgName)
{
MSG_ZGC_KNAPSACK_SYNC MSG_ZGC_KNAPSACK_SYNC = ProtoBuf.Serializer.Deserialize<MSG_ZGC_KNAPSACK_SYNC>(stream);
msgName = "MSG_ZGC_KNAPSACK_SYNC";
...
public void OnResponse_MSG_ZGC_KNAPSACK_UPDATE(MemoryStream stream,out string msgName)
{
MSG_ZGC_KNAPSACK_UPDATE MSG_ZGC_KNAPSACK_UPDATE = ProtoBuf.Serializer.Deserialize<MSG_ZGC_KNAPSACK_UPDATE>(stream);
msgName = "MSG_ZGC_KNAPSACK_UPDATE";
...
public void OnResponse_REWARD_ITEM_INFO(MemoryStream stream,out string msgName)
{
REWARD_ITEM_INFO REWARD_ITEM_INFO = ProtoBuf.Serializer.Deserialize<REWARD_ITEM_INFO>(stream);
msgName = "REWARD_ITEM_INFO";
...
public void OnResponse_ITEM(MemoryStream stream,out string msgName)
{
...
public void OnResponse_PLAYER_BASE_INFO(MemoryStream stream,out string msgName)
{
PLAYER_BASE_INFO PLAYER_BASE_INFO = ProtoBuf.Serializer.Deserialize<PLAYER_BASE_INFO>(stream);
msgName = "PLAYER_BASE_INFO";
...
public void OnResponse_FRIEND_REQUEST_INFO(MemoryStream stream,out string msgName)
{
FRIEND_REQUEST_INFO FRIEND_REQUEST_INFO = ProtoBuf.Serializer.Deserialize<FRIEND_REQUEST_INFO>(stream);
msgName = "FRIEND_REQUEST_INFO";
...
public void OnResponse_BLACK_INFO(MemoryStream stream,out string msgName)
{
...
public void OnResponse_FRIEND_SEARCH_INFO(MemoryStream stream,out string msgName)
{
FRIEND_SEARCH_INFO FRIEND_SEARCH_INFO = ProtoBuf.Serializer.Deserialize<FRIEND_SEARCH_INFO>(stream);
msgName = "FRIEND_SEARCH_INFO";
...
public void OnResponse_SHOW_CHARACTERINFO(MemoryStream stream,out string msgName)
{
SHOW_CHARACTERINFO SHOW_CHARACTERINFO = ProtoBuf.Serializer.Deserialize<SHOW_CHARACTERINFO>(stream);
msgName = "SHOW_CHARACTERINFO";
...
public void OnResponse_SHOW_SPACEINFO(MemoryStream stream,out string msgName)
{
SHOW_SPACEINFO SHOW_SPACEINFO = ProtoBuf.Serializer.Deserialize<SHOW_SPACEINFO>(stream);
msgName = "SHOW_SPACEINFO";
...
public void OnResponse_POP_RANK_PLAYER(MemoryStream stream,out string msgName)
{
POP_RANK_PLAYER POP_RANK_PLAYER = ProtoBuf.Serializer.Deserialize<POP_RANK_PLAYER>(stream);
msgName = "POP_RANK_PLAYER";
...
{
MSG_ZGC_DAMAGE MSG_ZGC_DAMAGE = ProtoBuf.Serializer.Deserialize<MSG_ZGC_DAMAGE>(stream);
msgName = "MSG_ZGC_DAMAGE";
Parser.Parse(MSG_ZGC_DAMAGE);
}
public object Deserialize_MSG_ZGC_DAMAGE(MemoryStream stream)
{
return  ProtoBuf.Serializer.Deserialize<MSG_ZGC_DAMAGE>(stream);
}

public void OnResponse_MSG_ZGC_CAST_SKILL(MemoryStream stream,out string msgName)
{
MSG_ZGC_CAST_SKILL MSG_ZGC_CAST_SKILL = ProtoBuf.Serializer.Deserialize<MSG_ZGC_CAST_SKILL>(stream);
...
{
return  ProtoBuf.Serializer.Deserialize<MSG_ZGC_CAST_SKILL>(stream);
}
...
{
Message.Gate.Protocol.GateC.Api.GenerateId();
Message.Client.Protocol.CGate.Api.GenerateId();
Message.Barrack.Protocol.BarrackC.BarrackCIdGenerator.GenerateId();
Message.Client.Protocol.CBarrack.Api.GenerateId();
}
