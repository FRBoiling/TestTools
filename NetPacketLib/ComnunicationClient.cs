...
{
    public class ComnunicationClient : AbstractTcpClient,SendMethodInterface
    {
        ...
        public bool Send<T>(T msg) where T : Google.Protobuf.IMessage
        {
        ...
        //{
        //    return packetHandler.PackageNormal(msg, Tcp.Send);
        //}
