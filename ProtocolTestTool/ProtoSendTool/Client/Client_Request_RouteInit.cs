...
return Init_MSG_CG_OPEN_CHEST();

case "MSG_CG_UNLOCK_CHEST":
return Init_MSG_CG_UNLOCK_CHEST();
...
return Init_MSG_CG_SHOW_CUR_CARDQUEUE();
...
return Init_MSG_CG_MATCHING_BATTLE();

case "MSG_CG_LEAVE_BATTLE_MAP":
return Init_MSG_CG_LEAVE_BATTLE_MAP();

case "MSG_CG_CHALLENGE_PLAYER":
return Init_MSG_CG_CHALLENGE_PLAYER();

case "MSG_CG_CHALLENGE_PLAYER_REQUEST":
return Init_MSG_CG_CHALLENGE_PLAYER_REQUEST();

case "MSG_CG_CHALLENGE_PLAYER_RESPONSE":
return Init_MSG_CG_CHALLENGE_PLAYER_RESPONSE();

case "MSG_CG_CHALLENGE_PLAYER_CANCEL":
return Init_MSG_CG_CHALLENGE_PLAYER_CANCEL();

case "MSG_CG_BATTLE_MAP_STATE_END":
return Init_MSG_CG_BATTLE_MAP_STATE_END();

case "MSG_CG_BATTLE_GET_MAP_STATE":
return Init_MSG_CG_BATTLE_GET_MAP_STATE();

case "MSG_CG_SYNC_SUMMON_ANIM":
return Init_MSG_CG_SYNC_SUMMON_ANIM();

case "MSG_CG_SYNC_SUMMON_ANGLE":
return Init_MSG_CG_SYNC_SUMMON_ANGLE();

case "MSG_CG_SYNC_SUMMON_INFO":
return Init_MSG_CG_SYNC_SUMMON_INFO();

case "MSG_CG_BATTLE_SKILL":
return Init_MSG_CG_BATTLE_SKILL();

case "MSG_CG_VEDIO_INFO":
return Init_MSG_CG_VEDIO_INFO();

case "MSG_CG_ENTER_TASK_BATTLE":
return Init_MSG_CG_ENTER_TASK_BATTLE();

case "MSG_CG_FINISH_TASK_BATTLE":
return Init_MSG_CG_FINISH_TASK_BATTLE();

case "MSG_CG_ENTER_PERSONAL_BATTLE":
return Init_MSG_CG_ENTER_PERSONAL_BATTLE();

case "MSG_CG_FINISH_PERSONAL_BATTLE":
return Init_MSG_CG_FINISH_PERSONAL_BATTLE();

case "MSG_CG_TEAM_CHALLENGE":
return Init_MSG_CG_TEAM_CHALLENGE();

case "MSG_CG_LEAVE_MATCHING":
return Init_MSG_CG_LEAVE_MATCHING();

case "MSG_CG_SYNC_BATTLE_EMOJI":
return Init_MSG_CG_SYNC_BATTLE_EMOJI();

case "MSG_CG_GET_SEASON_REWARD":
return Init_MSG_CG_GET_SEASON_REWARD();

case "MSG_CG_INVITE_FRIEND_FRIGHTING":
return Init_MSG_CG_INVITE_FRIEND_FRIGHTING();

case "MSG_CG_AGREE_INVITE_FRIGHTING":
return Init_MSG_CG_AGREE_INVITE_FRIGHTING();

case "MSG_CG_SURRENDER":
return Init_MSG_CG_SURRENDER();

case "MSG_CG_UPDATE_HERO_POSITION":
return Init_MSG_CG_UPDATE_HERO_POSITION();

case "MSG_CG_HERO_QUEUE_NAME":
return Init_MSG_CG_HERO_QUEUE_NAME();

case "MSG_CG_CUR_HERO_QUEUE":
return Init_MSG_CG_CUR_HERO_QUEUE();

case "MSG_CG_SKILL_QUEUE_NAME":
return Init_MSG_CG_SKILL_QUEUE_NAME();

case "MSG_CG_CUR_SKILL_QUEUE":
return Init_MSG_CG_CUR_SKILL_QUEUE();

case "MSG_CG_UPGRADE_HERO":
return Init_MSG_CG_UPGRADE_HERO();

case "MSG_CG_UPGRADE_SKILL":
return Init_MSG_CG_UPGRADE_SKILL();

case "MSG_CG_HERO_COMMENT":
return Init_MSG_CG_HERO_COMMENT();

case "MSG_CG_HERO_COMMENT_LIKES":
return Init_MSG_CG_HERO_COMMENT_LIKES();

case "MSG_CG_ADD_HERO_COMMENT":
return Init_MSG_CG_ADD_HERO_COMMENT();

case "MSG_CG_CALL_PET":
return Init_MSG_CG_CALL_PET();

case "MSG_CG_USE_HERO_SKIN":
return Init_MSG_CG_USE_HERO_SKIN();

case "MSG_CG_BUY_HERO_SKIN":
return Init_MSG_CG_BUY_HERO_SKIN();

case "MSG_CG_UPDATE_SKILL_POSITION":
return Init_MSG_CG_UPDATE_SKILL_POSITION();

case "MSG_CG_TASK_COMPLETE":
return Init_MSG_CG_TASK_COMPLETE();

case "MSG_CG_OPENE_HERO_TASK":
return Init_MSG_CG_OPENE_HERO_TASK();

case "MSG_CG_OPENE_EMAIL_TASK":
return Init_MSG_CG_OPENE_EMAIL_TASK();

case "MSG_CG_UNLOCK_HERO_STORY":
return Init_MSG_CG_UNLOCK_HERO_STORY();
...
return Init_MSG_CG_BATTLE_VEDIO_LIST();

case "MSG_CG_CHANGE_CHANNEL":
return Init_MSG_CG_CHANGE_CHANNEL();

case "MSG_CG_OPEN_BATTLE_VEDIO":
return Init_MSG_CG_OPEN_BATTLE_VEDIO();

case "MSG_CG_LEAVE_BATTLE_VEDIO":
return Init_MSG_CG_LEAVE_BATTLE_VEDIO();

case "MSG_CG_CHAT_VEDIO":
return Init_MSG_CG_CHAT_VEDIO();

case "MSG_CG_WATCHED_VEDIO":
return Init_MSG_CG_WATCHED_VEDIO();
